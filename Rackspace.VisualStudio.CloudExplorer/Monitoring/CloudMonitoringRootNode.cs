namespace Rackspace.VisualStudio.CloudExplorer.Monitoring
{
    ...
    public class CloudMonitoringRootNode : CloudProductRootNode
    {
        ...
        protected override Task<Node[]> CreateChildrenAsync(CancellationToken cancellationToken)
        {
            if (_children == null)
            {
                ...
                foreach (Endpoint endpoint in ServiceCatalog.Endpoints)
                    nodes.Add(new CloudMonitoringEndpointNode(_identity, ServiceCatalog, endpoint));
        ...
        public override Image Icon
        {
            get
            {
                return ServerExplorerIcons.CloudMonitoring;
            }
        }
